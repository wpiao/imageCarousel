...
import ShareButtonPortalEntry from './ShareButtonPortalEntry.jsx';
import svgPaths from '../elements/svgPaths';

const ShareButtonPortal = ({ shareButtonHandler }) => {
                ...
                <ContainerDiv name="4" background_color="rgb(255, 255, 255)" position="relative" widthvw="90" max_width="376" overflow="visible" top_margin="64" bottom_margin="64">
                  <ContainerDiv padding="32">
                    <ContainerDiv name="Xclose" bottom_margin="24">
                      <ShareCloseBtn onClick={() => shareButtonHandler(false)}>
                        <svg
                          viewBox="0 0 24 24"
                          aria-hidden="true"
                          focusable="false"
...
export default ShareButtonPortal;
